...
@Component({
  ...
  template: `
    <ibm-formio-form-field [instance]="instance"
...
export class MaterialDataGridComponent extends CarbonNestedComponent {
...
DataGridComponent.CarbonComponent = MaterialDataGridComponent;
