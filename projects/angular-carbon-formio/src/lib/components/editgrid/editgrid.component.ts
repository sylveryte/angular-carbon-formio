...
export class MaterialEditGridComponent extends CarbonNestedComponent implements AfterViewInit {
...
EditGridComponent.CarbonComponent = MaterialEditGridComponent;
